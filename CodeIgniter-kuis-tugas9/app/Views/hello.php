...
<head>
  ...
  -->
    ...
    <meta name="description" content="This is a Book eCommerce html template made by muhammad febriansyah">
  ...
  -->
        ...
        <div class="header-bottom" data-navbar>
            <div class="container">
                ...
                <a href="tel:+0123456789" class="header-contact-link">
                    ...
                    <span class="span">0821-4444-5148 (Rian)</span>
                </a>
    ...
    <main>
                ...
                <div class="container">
                    ...
                    <div class="hero-content">
                        ...
                        <h1 class="h1 hero-title has-after">
                            Dapatkan Koleksi Buku <br>
                            Baru Anda
                        </h1>

                        <p class="hero-text">
                            Ada banyak variasi kutipan Lorem Ipsum yang tersedia, tetapi sebagian besar mengalami alterasi
                        ...
                        <div class="btn-wrapper">
                            ...
                            <a href="#" class="btn">
                                <span class="span">Jelajahi Lebih Lanjut</span>

                                <ion-icon name="cart" aria-hidden="true"></ion-icon>
                            </a>

                            <button class="play-btn" aria-label="putar video">
                    ...
                    <figure class="hero-banner">
                        <img src="./assets/images/hero-banner.png" width="475" height="600" alt="banner pahlawan" class="w-100">
                    </figure>
      ...
      -->
                    ...
                    <div class="grid-list">
                        ...
                        <li>
                            <div class="feature-card">
                                ...
                                <div class="card-icon">
                                    <img src="./assets/images/feature-1.png" width="100" height="100" loading="lazy" alt="ikon fitur" class="w-100">
                                </div>

                                <div>
                                    <h3 class="h3 card-title">Pengiriman Gratis</h3>

                                    <p class="card-text">Pesan lebih dari Rp.150.000</p>
                                </div>
                        ...
                        <li>
                            <div class="feature-card">
                                ...
                                <div class="card-icon">
                                    <img src="./assets/images/feature-2.png" width="100" height="100" loading="lazy" alt="ikon fitur" class="w-100">
                                </div>

                                <div>
                                    <h3 class="h3 card-title">Pembayaran Aman</h3>

                                    <p class="card-text">Pembayaran 100% Aman</p>
                                </div>
                        ...
                        <li>
                            <div class="feature-card">
                                ...
                                <div class="card-icon">
                                    <img src="./assets/images/feature-3.png" width="100" height="100" loading="lazy" alt="ikon fitur" class="w-100">
                                </div>

                                <div>
                                    <h3 class="h3 card-title">Harga Terbaik</h3>

                                    <p class="card-text">Harga Terjangkau Terjamin</p>
                                </div>
                        ...
                        <li>
                            <div class="feature-card">
                                ...
                                <div class="card-icon">
                                    <img src="./assets/images/feature-4.png" width="100" height="100" loading="lazy" alt="ikon fitur" class="w-100">
                                </div>

                                <div>
                                    <h3 class="h3 card-title">Pengembalian Mudah</h3>

                                    <p class="card-text">Pengembalian dalam 30 Hari</p>
                                </div>
            ...
            <section class="section featured" aria-label="koleksi unggulan">
                <div class="container">

                    <h2 class="h2 section-title">Koleksi Unggulan</h2>

                    <p class="section-text">
                        Berbeda dengan kepercayaan populer, Lorem Ipsum bukanlah teks acak.
                    </p>
                            ...
                            <div class="product-card">
                                ...
                                <div class="card-banner img-holder" style="--width: 384; --height: 480;">
                                    ...
                                    <div class="card-action">
                                        ...
                                        <button class="action-btn" aria-label="lihat cepat" title="Lihat Cepat">
                                            <ion-icon name="eye-outline" aria-hidden="true"></ion-icon>
                                        </button>

                                        <button class="action-btn" aria-label="tambah ke wishlist" title="Tambah ke Wishlist">
                                            <ion-icon name="heart-outline" aria-hidden="true"></ion-icon>
                                        </button>

                                        <button class="action-btn" aria-label="bandingkan" title="Bandingkan">
                                            <ion-icon name="repeat-outline" aria-hidden="true"></ion-icon>
                                        </button>

                                        <button class="action-btn" aria-label="tambah ke keranjang" title="Tambah ke Keranjang">
                                            <ion-icon name="bag-handle-outline" aria-hidden="true"></ion-icon>
                                        </button>
                                ...
                                <div class="card-content">
                                    ...
                                    <data class="card-price" value="80">Rp.240.000</data>
                        ...
                        <li>
                            <div class="product-card">
                                ...
                                <div class="card-content">
                                    ...
                                    <data class="card-price" value="19">Rp. 80.000</data>
                        ...
                        <li>
                            <div class="product-card">
                                ...
                                <div class="card-content">
                                    ...
                                    <data class="card-price" value="80">Rp. 50.000</data>
                        ...
                        <li>
                            <div class="product-card">
                                ...
                                <div class="card-content">
                                    ...
                                    <data class="card-price" value="55">Rp. 120.000</data>
                        ...
                        <li>
                            <div class="product-card">
                                ...
                                <div class="card-content">
                                    ...
                                    <data class="card-price" value="100">Rp. 100.000</data>
                        ...
                        <li>
                            <div class="product-card">
                                ...
                                <div class="card-content">
                                    ...
                                    <data class="card-price" value="89">Rp. 130.000</data>
                        ...
                        <li>
                            <div class="product-card">
                                ...
                                <div class="card-content">
                                    ...
                                    <data class="card-price" value="34">Rp. 40.000</data>
                        ...
                        <li>
                            <div class="product-card">
                                ...
                                <div class="card-content">
                                    ...
                                    <data class="card-price" value="67">Rp. 67.000</data>
      ...
      -->
            ...
            <section class="section offer has-bg-image" aria-label="special offer" style="background-image: url('./assets/images/section-bg.jpg')">
                <div class="container">
        ...
        - #POPULAR
      -->
            <section class="section popular" aria-label="koleksi populer">
                <div class="container">

                    <h2 class="h2 section-title">Koleksi Populer</h2>
                    ...
                    <ul class="filter-list">
                        ...
                        <li>
                            <button class="filter-btn" data-filter-btn="featured">Produk Unggulan</button>
                        </li>

                        <li>
                            <button class="filter-btn" data-filter-btn="new">Produk Baru</button>
                        </li>

                        <li>
                            <button class="filter-btn" data-filter-btn="sell">Produk Terlaris</button>
                        </li>
                        ...
                        <li class="scrollbar-item" data-filter="sell">
                            <div class="product-card">
                                ...
                                <div class="card-content">
                                    ...
                                    <data class="card-price" value="34">Rp. 34.000</data>
...
-->
            ...
            <section class="section blog" aria-label="blog">
                <div class="container">
                    ...
                    <h2 class="h2 section-title">Blog Terbaru</h2>
                    ...
                    <ul class="has-scrollbar">
                        ...
                        <li class="scrollbar-item">
                            <div class="blog-card">
                                ...
                                <figure class="card-banner img-holder" style="--width: 600; --height: 400;">
                                    <img src="./assets/images/blog-1.jpg" width="600" height="400" loading="lazy" alt="Significant reading has info" class="img-cover">
                                </figure>

                                <div class="card-content">

                                    <h3 class="h3">
                                        <a href="#" class="card-title">Pembacaan yang Signifikan Memiliki Informasi</a>
                                    </h3>

                                    <ul class="card-meta-list">

                                        <li class="meta-item">
                                            <time class="meta-link" datetime="2022-03-04">04 Maret, 2022</time>
                                        </li>

                                        <li class="meta-item">
                                            <a href="#" class="meta-link">1 komentar</a>
                                        </li>

                                    </ul>

                                    <p class="card-text">
                                        Liburan musim panas itu indah. Berpakaian untuk mereka bisa jauh lebih sulit: Packing ringan...
                                    </p>

                                    <a href="#" class="btn card-btn">Baca Selengkapnya...</a>
                        ...
                        <li class="scrollbar-item">
                            <div class="blog-card">
                                ...
                                <figure class="card-banner img-holder" style="--width: 600; --height: 400;">
                                    <img src="./assets/images/blog-2.jpg" width="600" height="400" loading="lazy" alt="Activities Book International" class="img-cover">
                                </figure>

                                <div class="card-content">

                                    <h3 class="h3">
                                        <a href="#" class="card-title">Buku Kegiatan Internasional</a>
                                    </h3>
                        ...
                        <li class="scrollbar-item">
                            <div class="blog-card">
                                ...
                                <figure class="card-banner img-holder" style="--width: 600; --height: 400;">
                                    <img src="./assets/images/blog-3.jpg" width="600" height="400" loading="lazy" alt="International activities of the book" class="img-cover">
                                </figure>

                                <div class="card-content">

                                    <h3 class="h3">
                                        <a href="#" class="card-title">Kegiatan Internasional Buku</a>
                                    </h3>
    ...
    <footer class="footer has-bg-image" style="background-image: url('./assets/images/section-bg.jpg')">
        ...
        <div class="footer-bottom">
            <div class="container">
                ...
                <img src="./assets/images/payment-mehtod.png" width="311" height="30" loading="lazy" alt="Payment method" class="w-100">
